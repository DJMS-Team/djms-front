...
export const Billboard = ({title, photoUrl, subtitle, btnText}:BillboardProps) => {
    return (
        <div className="overflow-hidden ">
          <div className='min-h-screen relative aspect-square md:aspect-[2.4/1] overflow-hidden bg-cover bg-fixed bg-center lg:bg-right-bottom object-scale-down [mask-image:linear-gradient(_white_99%,_transparent_)] bg-dark'
